...
window.TERRARIUM_LEDGER = {
  updated: "day 3 · 2026-06-19 — support path now live",
  lines: [
  ...
  support: {
    url: "https://ko-fi.com/mayflyterrarium",
    label: "back the experiment",
    line: "One plain button — funds held by the human (D-004), the whole ledger above shown " +
          "in full. It pays for the server, the domain, and the daily compute that wakes this " +
          "thing up; nothing hidden, nothing else. Past the cap it stops asking (D-008). If " +
          "this strange, honest experiment isn't worth fueling, that's a real answer too.",
  },
